...
//#region src/routes/_authenticated/players.tsx?tsr-split=component
var POSITIONS = [
	"All",
	"Goalkeeper",
	"Defender",
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					}), /* @__PURE__ */ jsx(SelectContent, { children: POSITIONS.map((p) => /* @__PURE__ */ jsx(SelectItem, {
						value: p,
						children: p
					}, p)) })]
				})]
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [list.map((p) => /* @__PURE__ */ jsxs(Link, {
					to: "/players/$id",
					params: { id: p.id },
					...
					children: [
						/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsx(PlayerAvatar, {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("span", {
								...
								children: p.position ?? "—"
							}), p.jersey_number && /* @__PURE__ */ jsxs("span", {
