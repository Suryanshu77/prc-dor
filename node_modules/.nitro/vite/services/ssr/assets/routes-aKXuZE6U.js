...
import { t as trophy_hero_default } from "./trophy-hero-CljfJabd.js";
import { Link, Navigate } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { Sparkles, Trophy, Users, Vote } from "lucide-react";
//#region src/routes/index.tsx?tsr-split=component
function Landing() {
	const { user, loading } = useAuth();
	if (loading) return null;
	if (user) return /* @__PURE__ */ jsx(Navigate, { to: "/dashboard" });
	return /* @__PURE__ */ jsxs("div", {
		className: "relative min-h-screen overflow-hidden",
		children: [
			/* @__PURE__ */ jsx("div", {
				className: "pointer-events-none absolute inset-0 -z-10",
				children: /* @__PURE__ */ jsx("div", { className: "absolute -top-32 left-1/2 h-[600px] w-[600px] -translate-x-1/2 rounded-full bg-[var(--gold)] opacity-10 blur-3xl" })
			}),
			/* @__PURE__ */ jsxs("nav", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-3 w-3" }), " PRC D'or 2026"]
						}),
						/* @__PURE__ */ jsxs("h1", {
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: [
								...
								children: [/* @__PURE__ */ jsx(Icon, { className: "mb-2 h-5 w-5 text-gold" }), /* @__PURE__ */ jsx("div", {
					...
					className: "relative",
					children: [/* @__PURE__ */ jsx("div", { className: "absolute inset-0 -z-10 rounded-full bg-[var(--gold)] opacity-20 blur-3xl" }), /* @__PURE__ */ jsx("img", {
