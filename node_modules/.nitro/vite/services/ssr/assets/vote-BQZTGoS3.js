...
import { n as useAuth } from "./auth-C9iSOyPB.js";
import { t as cn } from "./utils-C_uf36nf.js";
import { t as Button } from "./button-BkEeRci-.js";
import { t as PlayerAvatar } from "./PlayerAvatar-DWQl0Nc4.js";
...
import { AlertTriangle, Check, GripVertical, Plus, X } from "lucide-react";
import { DndContext, PointerSensor, TouchSensor, closestCenter, useSensor, useSensors } from "@dnd-kit/core";
import { SortableContext, arrayMove, useSortable, verticalListSortingStrategy } from "@dnd-kit/sortable";
import { CSS } from "@dnd-kit/utilities";
import * as DialogPrimitive from "@radix-ui/react-dialog";
//#region src/lib/points.ts
var POINTS_BY_RANK = {
	1: 15,
	2: 12,
	3: 10,
...
//#endregion
//#region src/routes/_authenticated/vote.tsx?tsr-split=component
function VotePage() {
	const { user } = useAuth();
	...
	const eligible = useMemo(() => (playersQ.data ?? []).filter((p) => p.id !== user?.id), [playersQ.data, user]);
	const available = useMemo(() => eligible.filter((p) => !ranking.find((r) => r.id === p.id)), [eligible, ranking]);
	const sensors = useSensors(useSensor(PointerSensor), useSensor(TouchSensor));
	const alreadyVoted = (myVoteQ.data ?? []).length > 0;
	if (periodQ.isLoading || playersQ.isLoading) return /* @__PURE__ */ jsx("div", {
		className: "py-20 text-center text-muted-foreground",
		children: "Loading the voting booth…"
	});
	if (!periodQ.data?.is_active) return /* @__PURE__ */ jsx(EmptyState, {
		title: "Voting is closed",
		desc: "The voting period isn't active right now. Check back soon!"
	});
	if (alreadyVoted) return /* @__PURE__ */ jsx(EmptyState, {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							}), ranking.length > 0 && /* @__PURE__ */ jsx("button", {
								className: "text-xs text-muted-foreground hover:text-destructive",
								onClick: () => setRanking([]),
								children: "Clear"
							})]
						}),
						ranking.length === 0 ? /* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsx(SortableContext, {
								...
								children: /* @__PURE__ */ jsx("ol", {
									className: "space-y-2",
									children: ranking.map((p, i) => /* @__PURE__ */ jsx(SortableRow, {
										player: p,
										index: i,
					...
					children: [/* @__PURE__ */ jsx("h2", {
						...
						children: [available.map((p) => /* @__PURE__ */ jsxs("button", {
							onClick: () => add(p),
							disabled: ranking.length >= 10,
							...
							children: [
								...
								/* @__PURE__ */ jsx(Plus, { className: "h-4 w-4 text-gold opacity-0 transition group-hover:opacity-100" })
							]
						}, p.id)), available.length === 0 && /* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs(DialogContent, {
					...
					children: [
						/* @__PURE__ */ jsxs(DialogHeader, { children: [/* @__PURE__ */ jsxs(DialogTitle, {
							...
							children: [/* @__PURE__ */ jsx(AlertTriangle, { className: "h-5 w-5 text-gold" }), " Confirm your vote"]
						}), /* @__PURE__ */ jsx(DialogDescription, { children: "Are you sure? Votes cannot be changed after submission." })] }),
						/* @__PURE__ */ jsx("ol", {
							className: "max-h-72 space-y-1 overflow-y-auto text-sm",
							children: ranking.map((p, i) => /* @__PURE__ */ jsxs("li", {
	...
	return /* @__PURE__ */ jsxs("li", {
		...
		children: [
			/* @__PURE__ */ jsx("button", {
				...
				children: /* @__PURE__ */ jsx(GripVertical, { className: "h-5 w-5" })
			}),
			/* @__PURE__ */ jsx("div", {
