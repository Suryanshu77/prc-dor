  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 font-display text-xl text-foreground">Off the pitch</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          The page you're looking for isn't part of the squad.
        </p>
        <div className="mt-6">
          <Link
            to="/"
  ...
  head: () => ({
    meta: [
      ...
      { title: "PRC D'or — Football Community Awards" },
      {
        name: "description",
        content:
          "The PRC society's annual football awards. Vote for the best player in your community and crown the PRC D'or.",
      },
      { property: "og:title", content: "PRC D'or — Football Community Awards" },
      { property: "og:description", content: "Vote, rank, and crown the PRC D'or winner." },
